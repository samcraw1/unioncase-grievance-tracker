...
CREATE TABLE public.users (
    ...
    CONSTRAINT users_craft_check CHECK (((craft)::text = ANY ((ARRAY['carrier'::character varying, 'clerk'::character varying, 'maintenance'::character varying, 'supervisor'::character varying, 'other'::character varying])::text[]))),
